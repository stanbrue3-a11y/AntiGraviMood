...
export default function EditProfileScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Ambient Blobs */}
      <View
        style={[styles.blob, { backgroundColor: '#8ccaf7', top: -100, left: -50, opacity: 0.2 }]}
      />
      <View
        style={[
          styles.blob,
          { backgroundColor: '#c499ff', bottom: -100, right: -50, opacity: 0.15 },
        ]}
      />
      ...
      >
        ...
        <View style={styles.avatarSection}>
          ...
          <Text style={[styles.changeKeyText, { color: theme.text.secondary }]}>
              ...
              <TextInput
                style={[
                  styles.input,
                  {
                    ...
                    borderBottomColor:
                      focusedInput === 'name' ? '#c499ff' : 'rgba(150,150,150,0.2)',
                  },
                ]}
                value={name}
