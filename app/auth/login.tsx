      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            <View style={[styles.logoBg, { flexDirection: 'row', overflow: 'hidden' }]}>
          ...
          <Text style={[styles.title, { color: theme.text.primary }]} accessibilityRole="header">
            MoodMap
          </Text>
        ...
        <Pressable
          onPress={handleLogin}
          disabled={loading}
          style={({ pressed }) => [styles.button, { transform: [{ scale: pressed ? 0.98 : 1 }] }]}
          accessibilityRole="button"
          accessibilityLabel={loading ? 'Connexion en cours' : 'Se connecter'}
          accessibilityState={{ disabled: loading }}
        >
          <View style={[styles.buttonGradient, { backgroundColor: isDark ? '#fff' : '#000' }]}>
            {loading ? (
        ...
        <View style={styles.footer}>
          ...
          >
            <Text style={[styles.link, { color: theme.text.secondary }]}>
              ...
              <Text style={{ color: '#8ccaf7', fontWeight: '700' }}>Créer</Text>
            </Text>
          </Pressable>
