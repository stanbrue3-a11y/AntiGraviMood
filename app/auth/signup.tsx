...
export default function SignupScreen() {
  ...
  const onSubmit = async (data: SignupFormValues) => {
    try {
      ...
      if (success) {
        if ((authData as { session?: unknown })?.session) {
          ...
          <View style={styles.inputContainer}>
            <View style={styles.inputGroup}>
              <Ionicons
                name="person"
                size={20}
                color={errors.name ? palette.error : theme.text.muted}
          ...
          <View style={styles.inputContainer}>
            <View style={styles.inputGroup}>
              <Ionicons
                name="mail"
                size={20}
                color={errors.email ? palette.error : theme.text.muted}
                style={styles.inputIcon}
              />
              <Controller
                control={control}
          ...
          <View style={styles.inputContainer}>
            <View style={styles.inputGroup}>
              <Ionicons
                name="lock-closed"
                size={20}
                color={errors.password ? palette.error : theme.text.muted}
                style={styles.inputIcon}
              />
              <Controller
                control={control}
