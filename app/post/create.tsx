...
import { View, Text, StyleSheet, Pressable, TextInput, ScrollView, ActivityIndicator, KeyboardAvoidingView, Platform, Keyboard } from 'react-native';
...
export default function CreateMomentModal() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Video Thumbnail generation temporarily disabled due to native module issue
            /*
            if (media.type === 'video') {
                try {
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            >
                ...
                >
                    ...
                    {/* Place Search & Selection (Strictly Existing Places) */}
                    <View style={styles.section}>
                        <Text style={[styles.sectionTitle, { color: theme.text.secondary }]}>LIEU (OBLIGATOIRE)</Text>

                        <View style={[styles.searchBar, { backgroundColor: theme.surface }]}>
                            <Ionicons name="search" size={20} color={theme.text.secondary} />
                            <TextInput
                                style={[styles.searchInput, { color: theme.text.primary }]}
                                placeholder="Rechercher un lieu du guide..."
                                ...
                                return (
                                    <Pressable
                                        ...
                                        onPress={() => {
                                            ...
                                            // Optional: fill caption with place name? No, let user decide.
                                        }}
                                        style={[
                                            styles.placeChip,
                                            {
                        ...
                        {!selectedPlaceId && searchQuery.length > 0 && filteredPlaces.length === 0 && (
                            <Text style={{ color: '#ef4444', marginTop: 8, fontSize: 12 }}>
                                Aucun lieu trouvé. Vous devez choisir un lieu existant.
                            </Text>
                        )}
                    </View>
                    ...
                    >
                        {media ? (
                            <>
                                <Image source={{ uri: media.uri }} style={[styles.mediaImage, { height: 400 }]} contentFit="cover" transition={400} />
