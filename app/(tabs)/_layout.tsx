...
const TABS = [
  { name: 'map', title: 'Carte', icon: 'map-outline' as const, iconFilled: 'map' as const },
  {
    ...
    iconFilled: 'compass' as const,
  },
  {
    name: 'feed',
    title: 'Moments',
    icon: 'images-outline' as const,
    iconFilled: 'images' as const,
  }, // Moments partagés
  {
    name: 'profile',
    title: 'Profil',
  ...
  return (
    <Tabs
      screenOptions={{
        ...
        // Bugatti Grade v3: Pre-loading all tabs causes massive RAM pressure on boot.
        // Lazy loading defers mounting off-screen heavy lists/maps until requested.
        lazy: true,
      }}
