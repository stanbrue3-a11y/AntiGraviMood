...
const payload = {
  ...
  sensory_material:
    'les jardinières d’hibiscus et d’hortensias qui encadrent la terrasse tranquille',
  sensory_noise:
    'les chuchotements et rires discrets autour des grands plateaux de mezzés partagés',
  description:
  ...
  tags: ['new_lot'],
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photos vérifiées : magnifique terrasse verte et fleurie en soirée, mezzés premium, feuilles de vigne. Correction métro Denfert-Rochereau.',
  ],
};
...
try {
  ...
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'assanabel-alesia', JSON.stringify(payload)],
    {
      stdio: 'inherit',
    },
  );
