...
const updates: UpdatePayload[] = [
  {
    ...
    description: "Des tables en bois sombre et des murs décorés d'affiches vintage caractérisent la petite salle de cette cantine vietnamienne. L'atmosphère reste calme et reposante, propice à un déjeuner posé. On y savoure des spécialités parfumées comme le phở fumant ou des raviolis cuits à la vapeur.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Un comptoir en bois clair entoure la cuisine ouverte de ce restaurant de ramen inspiré des stands de rue japonais. L'ambiance reste calme et ordonnée, rythmée par un bruit discret de bouillonnement des marmites. On y déguste des bouillons mijotés de longues heures et des nouilles maison.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Des murs en briques sombres et des assises confortables délimitent la salle de ce bistrot thaïlandais contemporain. Sous des lumières douces et suspendues, l'atmosphère reste calme et intime. On y découvre des plats classiques revisités aux épices fraîches et lait de coco.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Des nappes blanches et un mobilier sobre ornent la salle feutrée de cette table gastronomique. L'ambiance y est calme et particulièrement propice à la concentration, rythmée par un discret bruit de chuchotement. Le menu dégustation propose des assiettes fines aux influences franco-japonaises.",
    insider_tips: [
