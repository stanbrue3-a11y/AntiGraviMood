...
const payload = {
  ...
  dogme_exact_quote:
    'Le fait de pouvoir choisir l’intensité du piquant dans son bouillon est juste génial',
  raw_facts: [
  ...
  tags: ['new_lot'],
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photos vérifiées : salle avec lanternes rouges, dragon suspendu, nouilles en bouillon rouge.',
  ],
};
