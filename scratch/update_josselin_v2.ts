...
const payload = {
  ...
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photo 0 = Petit Josselin (Annexe n°59), Photo 1 = Galettes traditionnelles. Validation visuelle ok.',
  ],
};
