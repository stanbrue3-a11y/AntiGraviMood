...
const payload = {
  ...
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photos vérifiées : papier peint art déco, tables en marbre vert, chaises et banquettes en velours (Index #0), plats bistronomiques raffinés (Saint-Jacques, poulpe riz vénéré, brioche perdue). Pas de terrasse extérieure.',
  ],
};
...
try {
  ...
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'le-jeroboam', JSON.stringify(payload)],
    {
      stdio: 'inherit',
    },
  );
