...
const updates: UpdatePayload[] = [
  {
    ...
    description: "Des cloisons coulissantes en papier de riz et des tables en bois clair habillent l'espace épuré de cette adresse japonaise de la rue du Maine. L'ambiance y reste calme et apaisante, idéale pour un déjeuner discret. On y déguste des sushis, sashimis et tempuras préparés avec rigueur.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Des suspensions en paille tressée et des tables en bois brut décorent la salle sobre de cette cantine vietnamienne. L'atmosphère est calme et propice à la détente, rythmée par un murmure discret des convives. La cuisine propose des spécialités soignées comme les nems croustillants et les bo buns.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Un comptoir en zinc classique et des banquettes en velours rouge accueillent les convives de ce bistrot de quartier. Sous un éclairage tamisé, l'atmosphère reste calme et posée, agrémentée d'une musique de fond légère. La carte décline des recettes typiques de la cuisine bourgeoise.",
    insider_tips: [
