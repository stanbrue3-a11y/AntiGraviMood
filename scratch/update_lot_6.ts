...
const updates: UpdatePayload[] = [
  {
    ...
    description:
      "Des briques rouges aux murs et des tables en bois rustique caractérisent la salle de cette trattoria. L'ambiance reste calme et propice à la détente. Sous des suspensions de paille tressée, on y déguste des pizzas cuites à la commande et des pâtes fraîches savoureuses.",
    insider_tips: [
  ...
  },
  {
    ...
    description:
      'Des tables en bois clair et des murs ornés de faïence blanche accueillent les convives dans cette crêperie. La salle lumineuse offre une atmosphère calme et décontractée, propice à la découverte de recettes originales à base de sarrasin biologique.',
    insider_tips: [
  ...
  },
  {
    ...
    description:
      "Des tables en métal brossé et des suspensions industrielles dessinent l'espace de ce restaurant coréen. L'ambiance reste calme et ordonnée, rythmée par un bruit discret de friture en cuisine. On y savoure du poulet frit croustillant enrobé de sauces maison.",
    insider_tips: [
  ...
  },
  {
    ...
    description:
      "Un comptoir en bois verni sous des lumières tamisées structure la petite salle de cet établissement. L'atmosphère reste calme et posée, idéale pour savourer des spécialités de la région lyonnaise comme le tablier de sapeur.",
    insider_tips: [
