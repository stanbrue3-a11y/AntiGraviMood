...
const payload = {
  dogme_source:
    'bistronomique, chef Alexandre Aziza, cuisine ouverte, produits de saison, vins nature, comptoir',
  description:
  ...
  insider_tip:
    '• Installez-vous directement au comptoir pour profiter du ballet de la cuisine ouverte et échanger avec la brigade.\n• Laissez-vous guider les yeux fermés sur les recommandations de vins nature qui épousent la carte évolutive.',
...
try {
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'barbo', JSON.stringify(payload)],
    {
