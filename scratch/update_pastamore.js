...
const payload = {
    ...
    tags: ['new_lot'],
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : végétation plafond, chaises rotin, assiettes de pâtes et raviolis."]
};

try {
    console.log("Updating Pastamore...");
    execFileSync('npx', ['tsx', 'scripts/agent_bridge.ts', '--update', 'pastamore', JSON.stringify(payload)], {
        stdio: 'inherit'
    });
} catch (e) {
