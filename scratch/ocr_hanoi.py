...
directory = "/Users/stanbrue/Documents/AntiGraviMood/moodmap/scratch/tmp_menu_downloads/hanoi-quan-montparnasse"
files = sorted([f for f in os.listdir(directory) if f.startswith("menu_") and (f.endswith(".png") or f.endswith(".jpg"))])
