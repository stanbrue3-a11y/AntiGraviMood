...
const payload = {
  ...
  tags: ['new_lot'],
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photo 0: Façade en bois foncé avec grand store rouge. Hottes cuivrées visibles à travers la vitrine.',
  ],
};
...
try {
  ...
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'koko-grill', JSON.stringify(payload)],
    {
      stdio: 'inherit',
    },
  );
