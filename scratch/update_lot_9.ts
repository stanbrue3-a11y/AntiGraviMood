...
const updates = [
  {
    ...
    description:
      "Des comptoirs en bois clair et des chaises hautes entourent la cuisine ouverte de cette adresse japonaise de la rue du Montparnasse. Les lampions rouges à l'entrée et la salle sobre dégagent une atmosphère calme. On y savoure des brochettes de poulet caramélisées au gril et des sashimis coupés minute.",
    insider_tips: [
  ...
  },
  {
    ...
    description:
      'Des comptoirs en bois sombre patinés par le temps accueillent les habitués de cette adresse japonaise ouverte depuis les années 70. Dans une ambiance calme jalonnée par un murmure feutré, des brochettes yakitori et des poissons crus sont préparés devant les convives. Les murs en crépi et les lampions en papier diffusent une atmosphère apaisante.',
    insider_tips: [
  ...
  },
  {
    ...
    description:
      "Un long comptoir en zinc brillant et des tabourets de bar accueillent les convives de ce café-bistrot de quartier. La salle lumineuse dégage une ambiance calme et détendue, rythmée par le bruit de vaisselle feutré en cuisine. La carte fait la part belle aux spécialités maison comme l'entrecôte et les frites dorées.",
    insider_tips: [
