...
const payload = {
  ...
  sensory_material:
    'le carrelage rouge au sol et les tables sombres sous la devanture en bois classique',
  sensory_noise: 'le crépitement des galettes sur la billig et le brouhaha du service continu',
  description:
    "Depuis que les trains de nuit en provenance de Bretagne déversaient leurs passagers gare Montparnasse dans les années 1920, le quartier a vu s'installer une colonie de crêperies bretonnes. L'Île au Blé Noir en garde l'ADN intact : devanture en bois sombre, enseigne néon rouge, carrelage rouge au sol. Les galettes de blé noir arrivent bien croustillantes en bordure, fondantes au centre, avec l'œuf coulant logé au cœur. Le cidre tombe en bolée. Le service continu en fait un repère de quartier à toute heure.",
  ...
  tags: ['new_lot'],
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Photos vérifiées : façade bois/néon rouge, galettes blé noir, crêpes caramel, bolée de cidre.',
  ],
};
...
try {
  ...
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'l-ile-au-ble-noir', JSON.stringify(payload)],
    {
      stdio: 'inherit',
    },
  );
