...
const payload = {
    ...
    tags: ['new_lot'],
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : terrasse bois couverte avec bâches transparentes, carte d'Italie d'ingrédients, assiette de spaghetti vongole."]
};

try {
    console.log("Updating Il Barone...");
    execFileSync('npx', ['tsx', 'scripts/agent_bridge.ts', '--update', 'il-barone', JSON.stringify(payload)], {
        stdio: 'inherit'
    });
} catch (e) {
