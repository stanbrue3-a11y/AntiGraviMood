...
const payload = {
    ...
    sensory_material: 'le parquet en bois clair et les banquettes rayées sous des suspensions cuivrées',
    sensory_noise: 'le brouhaha d\'une terrasse de quartier animée les jours de beau temps',
    description: "À l'angle du boulevard, Harper's s'annonce d'abord par sa terrasse : des chaises en rotin bleu encadrent des colonnes entièrement couvertes de bougainvilliers fuchsia. À l'intérieur, le parquet en bois clair, les banquettes tapissées de rayures et les murs en brique blanche composent un décor de brasserie sous des suspensions cuivrées industrielles. La carte alterne plats réconfortants soignés — poulet pané panko, pièce de bœuf sur ardoise — et quelques touches plus travaillées à la truffe.",
    insider_tips: [
    ...
    tags: ['new_lot'],
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : terrasse bougainvilliers, chaises rotin bleu, intérieur brique/parquet/cuivre, assiettes chicken panko et bœuf ardoise."]
};
