...
const payload = {
  description:
    "Derrière son grand store vert amande et sa terrasse végétalisée, Partage Brasserie casse les codes du bistrot de quartier. À l'intérieur, les murs en briques grattées et le mobilier en bois clair posent un décor brut et décomplexé. Le concept est dans le nom : on vient ici pour s'attabler en bande et piocher dans des assiettes centrales aux accents du Sud-Ouest. L'atmosphère, rythmée par le ballet des quilles de vin nature, est résolument chill et décontractée.",
  insider_tip:
    "• C'est le paradis du 'sharing' : oubliez le classique entrée-plat-dessert et commandez plein de petites assiettes au centre de la table.\n• La sélection de vins natures est pointue, laissez-vous guider par l'équipe pour un accord parfait avec vos tapas.\n• La terrasse est particulièrement agréable aux beaux jours, un vrai luxe dans la rue Didot.",
  dominant_mood: 'chill',
  hero_image:
    'Ab43m-sYpYQcM-OqV_vO0Uj2L5YqLpQYqH_5b1J_tN-pX-L-4qV_Y0L0-0K5oO1eB-Z0-R9R40K0J1z0J-lGkI-mNnS7oD9v-r_3Vw-Ew_N9Q-5_mY-Q9I_m0J_eX_D_l-B0V-9Z-G_pX_Q_xV_v_yJ-X_zJ_yL_B_jM_iI_cZ_oJ_vY_lO_iL_xX', // This will be overwritten by agent_bridge anyway
  google_photos: [
  ...
  tags: ['pastille_rouge'],
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Hero Façade (Photo 2). Immersion Salle (Photo 0). Plats Partage (Photos 1,3,4). Dogme Partage/Tapas validé. Status: TITAN.',
  ],
};

const output = execFileSync(
  'npx',
  ['tsx', 'scripts/agent_bridge.ts', '--update', 'partage-brasserie', JSON.stringify(payload)],
  { encoding: 'utf-8' },
);
console.log(output);
