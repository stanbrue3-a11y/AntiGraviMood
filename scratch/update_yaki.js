...
const payload = {
    ...
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : salle feutrée avec banquettes rouges/zebra, comptoir laque noire, plats sushis/yakitoris de qualité. Terrasse de trottoir validée."]
};

try {
    console.log("Updating Yaki...");
    execFileSync('npx', ['tsx', 'scripts/agent_bridge.ts', '--update', 'yaki', JSON.stringify(payload)], {
        stdio: 'inherit'
    });
} catch (e) {
