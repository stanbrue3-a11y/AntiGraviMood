...
const updates: UpdatePayload[] = [
  {
    ...
    description: "À deux pas de l'agitation de la gare Montparnasse, ce lieu propose une halte silencieuse aux amateurs de saveurs nippones. Derrière la vitrine sobre, quelques tables en bois clair entourent un comptoir où les cuisiniers préparent le porc pané. L'atmosphère est calme, propice à la dégustation d'une viande fondante enrobée d'une panure dorée et croustillante.",
    insider_tips: [
  ...
  },
  {
    ...
    description: "Située dans la célèbre rue des crêperies de la capitale, cette maison bretonne propose une halte gourmande. La salle étroite se caractérise par des boiseries sombres et des tables en bois rustiques sous des lumières tamisées. L'atmosphère est calme, rythmée par le sifflement de la vapeur d'eau sur les plaques de cuisson. On y savoure des galettes de sarrasin croustillantes servies dans de la vaisselle artisanale.",
    insider_tips: [
