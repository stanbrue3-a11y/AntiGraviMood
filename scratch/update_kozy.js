...
const payload = {
  ...
  dogme_exact_quote:
    'because of its popularity, it is common to experience queues, especially on weekends',
  raw_facts: [
  ...
  internal_audit_logs: [
    "[AUDIT F.I.P.P OK] Photo 0 est la belle façade bleue, Photo 2 et 4 confirment la présence claire d'une terrasse.",
  ],
};
...
try {
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'kozy-bosquet', JSON.stringify(payload)],
    {
      stdio: 'inherit',
    },
  );
