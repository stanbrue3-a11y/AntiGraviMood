...
const payload = {
    ...
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : magnifique comptoir en marbre noir devant les plaques teppanyaki (Index #0), pavés de saumon et bœuf saisis à la plaque, salle feutrée aux murs gris ardoise. Pas de terrasse extérieure."]
};

try {
    console.log("Updating Ayako Teppanyaki...");
    execFileSync('npx', ['tsx', 'scripts/agent_bridge.ts', '--update', 'ayako-teppanyaki', JSON.stringify(payload)], {
        stdio: 'inherit'
    });
} catch (e) {
