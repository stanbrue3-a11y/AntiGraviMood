...
const payload = {
    dominant_mood: 'chill',
    dogme_source: 'référence marine, sourçage huîtres David Hervé, déco cordages, terrasse végétalisée place Brancusi',
    ...
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Ordre validé : [0, 1, 2, 3, 4]. Photo 1 confirme le sourçage David Hervé."]
};
