...
const payload = {
  dominant_mood: 'chill',
  dogme_source:
    'référence marine, sourçage huîtres David Hervé, déco cordages, terrasse végétalisée place Brancusi',
  description:
  ...
  insider_tip:
    "• Aux beaux jours, privilégiez la terrasse ombragée de la place Brancusi pour son calme exceptionnel.\n• Explorez leur carte de Cognacs et Pineaux des Charentes, héritage historique du fondateur Gérard Allemandou.\n• Le sourçage est d'élite : les huîtres proviennent directement de chez David Hervé, une référence absolue du bassin de Marennes-Oléron.",
  nearest_metro: 'Gaîté',
  metro_lines: ['13'],
  has_terrace: true,
  ...
  internal_audit_logs: [
    '[AUDIT F.I.P.P OK] Ordre validé : [0, 1, 2, 3, 4]. Photo 1 confirme le sourçage David Hervé.',
  ],
};
...
try {
  execFileSync(
    'npx',
    ['tsx', 'scripts/agent_bridge.ts', '--update', 'la-cagouille', JSON.stringify(payload)],
    {
