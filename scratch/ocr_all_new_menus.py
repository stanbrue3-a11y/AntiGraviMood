...
output_dir = "/Users/stanbrue/Documents/AntiGraviMood/moodmap/scratch/ocr_results"
...
for slug in slugs:
    ...
    print(f"📖 Running OCR for: {slug} ({len(files)} files)")
    ...
    for filename in files:
        ...
        place_text.append(f"=== File: {filename} ===\n{text}")
