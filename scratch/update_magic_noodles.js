...
const payload = {
    ...
    tags: ['new_lot'],
    internal_audit_logs: ["[AUDIT F.I.P.P OK] Photos vérifiées : façade rouge mandarin, mur doré rétro-éclairé, bols bleu-blanc, nouilles et raviolis."]
};

try {
    console.log("Updating Magic Noodles...");
    execFileSync('npx', ['tsx', 'scripts/agent_bridge.ts', '--update', 'magic-noodles', JSON.stringify(payload)], {
        stdio: 'inherit'
    });
} catch (e) {
