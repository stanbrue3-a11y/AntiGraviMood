...
import {
  PriceEngine,
  DrinkType as DET_DrinkType,
  BENCHMARKS as DET_BENCHMARKS,
} from './pricing/PriceEngine';
...
export const getReferencePrice = (pricing: any, type: DrinkType) =>
  PriceEngine.getReferencePrice(pricing, type);
export const resolveReferencePrice = (pricing: any, type: DrinkType) =>
  PriceEngine.resolveReferencePrice(pricing, type);
