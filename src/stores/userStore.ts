...
const getFallbackAvatar = (name: string) =>
  `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=c499ff&color=fff`;
      ...
      set({
        user: {
          ...
          avatar:
            ...
            getFallbackAvatar(session.user.user_metadata?.full_name || 'Utilisateur'),
        },
      ...
      set({
        user: {
          ...
          avatar:
            ...
            getFallbackAvatar(data.user.user_metadata?.full_name || 'Utilisateur'),
        },
        isAuthenticated: true,
        isLoading: false,
      });
    ...
    if (data.user) {
      set({
        user: {
          ...
          avatar: getFallbackAvatar(fullName || 'Utilisateur'),
        },
        isAuthenticated: true,
        isLoading: false,
      });
      ...
      incomingRequests: [
        {
          ...
          name: 'Jean Test',
          username: 'jean_t',
          avatar: getFallbackAvatar('Jean Test'),
        } as User,
      ],
    });
  },
