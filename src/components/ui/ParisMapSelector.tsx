...
const DISTRICT_PATHS: { id: number; d: string; cx: number; cy: number }[] = [
  ...
  {
    id: 3,
    d: 'M202,125 L232,120 L245,138 L238,165 L212,160 L204,160 L212,142 Z',
    cx: 224,
    cy: 144,
  },
  ...
  {
    id: 4,
    d: 'M178,170 L204,160 L212,160 L238,165 L232,192 L202,198 L175,188 Z',
    cx: 205,
    cy: 178,
  },
  ...
  {
    id: 5,
    d: 'M175,188 L202,198 L208,220 L185,235 L158,225 L155,195 L160,175 Z',
    cx: 180,
    cy: 212,
  },
  {
    id: 6,
    d: 'M125,178 L145,160 L160,175 L155,195 L158,225 L130,235 L108,215 L112,188 Z',
    cx: 135,
    cy: 202,
  }, // Adjusted top-right to match 1
  {
    id: 7,
    d: 'M72,158 L112,148 L125,178 L112,188 L108,215 L75,225 L52,195 L55,168 Z',
    cx: 88,
    cy: 185,
  }, // Mostly unchanged, maybe slight nudge

  // Right Bank West - 8e, 9e (Pushed North/West)
  // 8 touches 1 at 148,138.
  {
    id: 8,
    d: 'M72,108 L118,95 L142,108 L148,138 L125,145 L112,148 L72,158 L58,135 Z',
    cx: 102,
    cy: 128,
  },
  ...
  {
    id: 10,
    d: 'M172,102 L205,92 L228,105 L232,120 L202,125 L174,132 L185,118 Z',
    cx: 205,
    cy: 110,
  },
  ...
  {
    id: 11,
    d: 'M232,120 L268,95 L288,115 L285,162 L250,175 L238,165 L245,138 Z',
    cx: 260,
    cy: 135,
  },
  ...
  {
    id: 12,
    d: 'M250,175 L285,162 L315,185 L320,248 L275,275 L228,258 L225,215 L208,220 L202,198 L232,192 L238,165 Z',
    cx: 272,
    cy: 225,
  }, // Matches 4 & 5
  ...
  {
    id: 13,
    d: 'M185,235 L228,258 L232,298 L192,315 L148,295 L155,258 L158,225 Z',
    cx: 192,
    cy: 275,
  },
  ...
  {
    id: 15,
    d: 'M32,188 L52,195 L75,225 L75,235 L68,275 L35,285 L12,238 L18,198 Z',
    cx: 48,
    cy: 242,
  },
  ...
  {
    id: 16,
    d: 'M12,128 L55,108 L72,108 L58,135 L72,158 L55,168 L52,195 L32,188 L8,158 Z',
    cx: 42,
    cy: 148,
  },
  ...
  {
    id: 18,
    d: 'M142,42 L195,28 L228,48 L235,85 L205,92 L172,102 L142,108 L142,62 Z',
    cx: 182,
    cy: 68,
  },
...
export const ParisMapSelector = React.memo(
  ({ selectedDistricts, onToggle }: ParisMapSelectorProps) => {
