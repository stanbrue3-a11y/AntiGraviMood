...
export const PlaceDescription = React.memo(() => {
    ...
    <View style={[styles.container, { backgroundColor: theme.surface, borderColor: theme.border }]}>
      <TouchableOpacity onPress={toggleExpand} style={styles.header} activeOpacity={0.7}>
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.label, { color: primaryColor }]}>L'HISTOIRE & LE LIEU</Text>
        </View>
        <Ionicons
      ...
      {!expanded && (
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={[styles.readMoreText, { color: primaryColor }]}>Lire la suite</Text>
        </TouchableOpacity>
      )}
    </View>
  );
