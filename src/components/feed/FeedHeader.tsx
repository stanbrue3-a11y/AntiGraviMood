  ...
  return (
    <View style={[styles.header, { top: topInset }]}>
      <View style={styles.switchContainer}>
        ...
        <Pressable
          style={[styles.switchOption, feedMode === 'global' && styles.activeSwitchGlobal]}
          onPress={() => onSwitchMode('global')}
        >
          <Text style={[styles.switchText, feedMode === 'global' && styles.activeSwitchText]}>
            Global
          </Text>
        </Pressable>
        <Pressable
          style={[styles.switchOption, feedMode === 'amis' && styles.activeSwitchAmis]}
          onPress={() => onSwitchMode('amis')}
        >
          <Text style={[styles.switchText, feedMode === 'amis' && styles.activeSwitchText]}>
            Amis
          </Text>
        </Pressable>
      </View>
