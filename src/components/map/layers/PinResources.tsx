...
export const useIconMatrix = () => {
  return useMemo(() => {
    ...
    const matrix: { id: string; icon: string; color: string }[] = [];
    icons.forEach((icon) => {
      moods.forEach((mood) => {
...
const getIconPath = (iconName: string) => {
  ...
  switch (iconName) {
    ...
    case 'cafe':
      return (
        <Path
          ...
          fill="white"
          transform={`scale(${ionScale})`}
        />
      );
    case 'cocktail':
      return (
        <Path
          d="M21,5V3H3v2l8,9v5H6v2h12v-2h-5v-5L21,5z M7.43,7L5.66,5h12.69l-1.78,2H7.43z"
          fill="white"
    ...
    case 'museum':
      return (
        <Path
          d="M12,2L2,7v2h20V7L12,2z M4,10h3v7H4V10z M10.5,10h3v7h-3V10z M17,10h3v7h-3V10z M2,19h20v3H2V19z"
          fill="white"
          transform="scale(0.85) translate(2,2)"
        />
      );
    case 'palette':
      return (
        <Path
          d="M12,3c-4.97,0-9,4.03-9,9c0,4.97,4.03,9,9,9c0.83,0,1.5-0.67,1.5-1.5c0-0.39-0.15-0.74-0.39-1.01 c-0.23-0.26-0.38-0.61-0.38-0.99c0-0.83,0.67-1.5,1.5-1.5H16c2.76,0,5-2.24,5-5C21,5.24,16.97,3,12,3z M6.5,13 c-0.83,0-1.5-0.67-1.5-1.5S5.67,10,6.5,10S8,10.67,8,11.5S7.33,13,6.5,13z M9.5,8C8.67,8,8,7.33,8,6.5S8.67,5,9.5,5S11,5.67,11,6.5 S10.33,8,9.5,8z M14.5,8c-0.83,0-1.5-0.67-1.5-1.5S13.67,5,14.5,5S16,5.67,16,6.5S15.33,8,14.5,8z M17.5,10.5c-0.83,0-1.5-0.67-1.5-1.5 S16.67,7.5,17.5,7.5S19,8.17,19,9S18.33,10.5,17.5,10.5z"
          fill="white"
          transform="scale(0.85) translate(2,2)"
        />
      );
    ...
    case 'lodging':
      return (
        <Path
          d="M7,13c1.66,0,3-1.34,3-3S8.66,7,7,7c-1.66,0-3,1.34-3,3S5.34,13,7,13z M19,7h-8v6H3V5H1v15h2v-3h18v3h2v-9C23,8.79,21.21,7,19,7z"
          fill="white"
          transform="scale(0.85) translate(2,2)"
        />
      );
    default:
      return (
        <Path
          ...
          fill="white"
          transform="scale(0.7) translate(4,4)"
        />
      );
  }
};
