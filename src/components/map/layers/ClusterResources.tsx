...
const CLUSTER_TYPES = [
  ...
  {
    id: 'balanced',
    colors: [moodColors.chill.primary, moodColors.festif.primary, moodColors.culturel.primary],
  },
];
...
export const getClusterImage = [
  'case',
  // 1. PURE (>85%)
  ['>', ['/', ['get', 'chill_count'], ['get', 'point_count']], 0.85],
  'cluster-chill-pure',
  ['>', ['/', ['get', 'festif_count'], ['get', 'point_count']], 0.85],
  'cluster-festif-pure',
  ['>', ['/', ['get', 'culturel_count'], ['get', 'point_count']], 0.85],
  'cluster-culturel-pure',

  // 2. DOMINANT (>50% Major)
  ['>', ['/', ['get', 'chill_count'], ['get', 'point_count']], 0.5],
  [
    'case',
    ['>', ['get', 'festif_count'], ['get', 'culturel_count']],
    'cluster-chill-festif',
    'cluster-chill-culturel',
  ],
  ['>', ['/', ['get', 'festif_count'], ['get', 'point_count']], 0.5],
  [
    'case',
    ['>', ['get', 'chill_count'], ['get', 'culturel_count']],
    'cluster-festif-chill',
    'cluster-festif-culturel',
  ],
  ['>', ['/', ['get', 'culturel_count'], ['get', 'point_count']], 0.5],
  [
    'case',
    ['>', ['get', 'chill_count'], ['get', 'festif_count']],
    'cluster-culturel-chill',
  ...
  [
    '>',
    ['/', ['+', ['get', 'chill_count'], ['get', 'festif_count']], ['get', 'point_count']],
    0.85,
  ],
  'cluster-chill-festif-equal',
  [
    '>',
    ['/', ['+', ['get', 'chill_count'], ['get', 'culturel_count']], ['get', 'point_count']],
    0.85,
  ],
  'cluster-chill-culturel-equal',
  [
    '>',
    ['/', ['+', ['get', 'festif_count'], ['get', 'culturel_count']], ['get', 'point_count']],
    0.85,
  ],
  'cluster-festif-culturel-equal',
          ...
          <Mapbox.Image key={type.id} name={`cluster-${type.id}`}>
            <Svg height="42" width="42" viewBox="0 0 44 44">
              ...
              <G origin="22, 22" rotation="0">
                {isPure && <Circle cx="22" cy="22" r="20" fill={type.colors[0]} />}
  ...
  return (
    <>
      <Mapbox.SymbolLayer
        ...
        style={
          {
            iconImage: getClusterImage as unknown as string,
