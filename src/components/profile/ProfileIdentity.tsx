...
type Props = {
  user: { avatar?: string; name?: string; username?: string; bio?: string } | null;
    ...
    <View style={[styles.card, { backgroundColor: COLORS.card, borderColor: COLORS.cardBorder }]}>
      ...
      <View style={styles.profileContent}>
        ...
        <View style={styles.infoContainer}>
          ...
          {user?.username && (
            <Text
              style={[styles.userName, { color: COLORS.textSecondary, fontSize: 16, marginTop: 0 }]}
            >
              @{user?.username}
            </Text>
          )}
        ...
        <View style={styles.progressBarBg}>
          <View
            style={[
              ...
              { width: `${stats.percentage}%`, backgroundColor: COLORS.orange },
            ]}
          />
        </View>
      </View>
