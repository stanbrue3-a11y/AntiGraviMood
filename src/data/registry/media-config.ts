...
/**
 * Media Configuration Registry 📸
 * Centralized maps for images and carousel fallbacks.
 */
...
export const DEFAULT_IMAGES_CAROUSEL: Record<string, string[]> = {
    'bar': [
        ...
        'https://images.unsplash.com/photo-1575444758702-4a6b9222336e?q=80&w=1000'
    ],
    'café': [
    ...
    'restaurant': [
        ...
        'https://images.unsplash.com/photo-1550966871-3ed3c47e2ce2?q=80&w=1000'
    ],
    'club': [
        ...
        'https://images.unsplash.com/photo-1545128485-c400e7702796?q=80&w=1000'
    ],
    'parc': [
        ...
        'https://images.unsplash.com/photo-1585938389612-a552a28d6914?q=80&w=1000',
        'https://images.unsplash.com/photo-1565036502284-88aa5cb4481c?q=80&w=1000'
    ],
    'museum': [
        ...
        'https://images.unsplash.com/photo-1545300306-0370d02462c1?q=80&w=1000',
        'https://images.unsplash.com/photo-1554907984-15263bfd63bd?q=80&w=1000'
    ],
    'espace-culturel': [
        ...
        'https://images.unsplash.com/photo-1515169273894-7e876dcf13da?q=80&w=1000'
    ],
