        ...
        menu_items: [
            ...
            // ═══════════════════════════════════════════
            {
                ...
                items: [
                    ...
                    { name: "Plat du jour canaille (midi)", price: "15.00€" },
                    { name: "Menu Déjeuner E+P ou P+D", price: "25.00€" },
                    { name: "Menu Déjeuner E+P+D", price: "29.00€" },
                    { name: "Menu Soir E+P+D", price: "35.00€" },
                    { name: "Menu Soir E+P+Fromages+D", price: "45.00€" }
                ]
            },
            // ═══════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════
            {
                ...
                items: [
                    ...
                    { name: "Pâté en croûte de pintade et foie gras", price: "16.00€" },
                    { name: "Harengs marinés d'Astier, pommes grenaille", price: "12.00€", description: "Le classique de la maison depuis 1956." },
                    { name: "Cuisses de grenouilles en persillade", price: "14.00€" },
                    { name: "Saint-Jacques en coquille (en saison)", price: "16.00€" },
                    { name: "Œuf en meurette", price: "10.00€" }
                ]
            },
            // ═══════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════
            {
                ...
                items: [
                    ...
                    { name: "Quenelle de daurade royale, sauce crustacés", price: "22.00€" },
                    { name: "Quasi de veau rôti", price: "25.00€" },
                    { name: "Demi-pigeonneau de Pornic rôti", price: "32.00€" },
                    { name: "Tronçon de turbot rôti", price: "39.00€" },
                    { name: "Filet de boeuf Simmental", price: "42.00€" }
                ]
            },
            // ═══════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════
            {
                category: "Fromages (affinés Maison Anthès)",
                items: [
                    // VERIFIED: Site officiel (2024)
                    { name: "Assiette de 5 fromages", price: "16.00€" },
                    { name: "Plateau de fromages par personne", price: "26.00€", description: "Le légendaire plateau à volonté, affiné par la Maison Anthès." },
                    { name: "Plateau à partager", price: "29.00€" }
                ]
            },
            // ═══════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════
            {
                ...
                items: [
                    ...
                    { name: "Clafoutis aux abricots", price: "10.00€" },
                    { name: "Riz au lait cannelle et orange", price: "9.00€" }
                ]
            },
            // ═══════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════
            {
                category: "Cave (400 références)",
                items: [
                    { name: "Verre de vin (à partir de)", price: "8.00€" },
                    { name: "Bouteille (à partir de)", price: "28.00€" },
                    { name: "Grands Bourgognes et Rhône", price: "80.00€" }
                ]
            }
        ]
    },
