...
export const chez_alphonse: SurgicalPlace = {
    ...
    "name": "Chez Alphonse",
    "slug": "chez-alphonse-paris-14",
    "category": "restaurant",
    "subcategory": ["bistro", "traditionnel", "terrasse", "fait-maison", "ardoise", "convivial"],
    "verified": true,
    "google_rating": 4.6,
    "location": {
        "address": "16 Rue Alphonse Daudet",
        "arrondissement": 14,
        "lat": 48.826872,
        "lng": 2.327089,
        "nearest_metro": "Alésia",
        "metro_lines": ["4"],
        "google_id": "ChIJIexdGitx5kcR9eaookGZGuI"
    },
    "practical": {
        ...
        "main_action": {
            "type": "book",
            "url": "https://www.thefork.fr/restaurant/chez-alphonse-r482015",
