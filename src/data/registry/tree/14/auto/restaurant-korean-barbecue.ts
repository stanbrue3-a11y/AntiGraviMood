...
export const restaurant_korean_barbecue: SurgicalPlace = {
  id: "poi-restaurant-korean-barbecue",
  ...
  location: {
    ...
    metro_lines: [6, 4, 12, 13],
    google_id: "ChIJteRCss5x5kcRs91glUUfnnU"
  },
  moods: {
    chill: 40,
    festif: 70,
  ...
  practical: {
    ...
    main_action: {
      type: "site",
      url: "https://maps.google.com/?cid=8475245932477210035",
